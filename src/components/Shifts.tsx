          ...
          <div className="bg-white p-6 rounded-xl shadow-lg max-w-7xl mx-auto overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full border-collapse rounded-lg overflow-hidden">
                ...
                <tbody className="divide-y divide-gray-200 text-gray-700">
                  {shifts.map((shift, index) => (
                    ...
                    >
              <td className="p-3 font-semibold text-center relative flex items-center justify-center gap-2"> <span className={`w-2 h-2 rounded-full ${shift.is_active ? "bg-green-500" : "bg-red-500"}`}></span> <span>{shift.is_active ? "ON" : "OFF"}</span> </td>
              <td className="p-3 font-semibold text-center">{shift.shiftName}</td>
                      ...
                      <td className="p-3 font-semibold text-center">{shift.startTime}-{shift.endTime}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="flex flex-col space-y-1">
                      ...
                      <input
                        type="time"
                        {...register("startTime")}
                        className="w-full px-4 py-2 border border-green-500 rounded-2xl bg-white text-gray-900 shadow-sm 
